...
struct per_transfer {
  ...
  volatile bool abort; /* when doing parallel transfers and this is TRUE then a critical
...
CURLcode operate(struct GlobalConfig *config, int argc, const char** argv);
