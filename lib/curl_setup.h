 ...
 *
 * [Edit:] Do NOT do this as it'll collide badly with other libraries and
 * applications which include both cURL and MSWindows' headers in the same
 * *GUI* source files!
 */
...
#  if !defined(_WIN32) || ((_MSC_VER < 1300) && !defined(_FILETIME_))
