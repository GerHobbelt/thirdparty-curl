...
struct curl_easyoption Curl_easyopts[] = {
  ...
  {"CREATE_DIRS_FOR_OUTPUT", CURLOPT_CREATE_DIRS_FOR_OUTPUT, CURLOT_LONG, 0},
  ...
  {"NOCLOBBER_OUTPUT_FILE", CURLOPT_NOCLOBBER_OUTPUT_FILE, CURLOT_LONG, 0},
  ...
  {"OUTPUT_PATH_MIMICS_URL", CURLOPT_OUTPUT_PATH_MIMICS_URL, CURLOT_LONG, 0},
  ...
  {"SANITIZE_WITH_EXTREME_PREJUDICE", CURLOPT_SANITIZE_WITH_EXTREME_PREJUDICE, CURLOT_LONG, 0},
  ...
  {"TIMEOUT_PER_ADDR", CURLOPT_TIMEOUT_PER_ADDR, CURLOT_LONG, 0},
