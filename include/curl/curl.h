...
enum curl_khcheck {
  CURLKHCHECK_UNKNOWN,
  CURLKHCHECK_FINE,   /* accept the connection */
  CURLKHCHECK_REJECT, /* reject the connection, return an error */
  CURLKHCHECK_LAST    /* not for use, only a marker for last-in-list */
};
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* CA cache timeout */
  CURLOPT(CURLOPT_CA_CACHE_TIMEOUT, CURLOPTTYPE_LONG, 323),

  CURLOPT(CURLOPT_NOCLOBBER_OUTPUT_FILE, CURLOPTTYPE_LONG, 324),
